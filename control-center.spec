...
Source: http://download.gnome.org/sources/gnome-control-center/3.10/gnome-control-center-%{version}.tar.xz
...
# Ilya Birman layout fix
Patch2: lv3-typo-default-layout.patch
...
%changelog
* Fri Nov  1 2013 Arkady L. Shane <ashejn@russianfedora.ru> - 1:3.10.1-1.R
- fix Birman layout usage

* Tue Oct 15 2013 Richard Hughes <rhughes@redhat.com> - 1:3.10.1-1
- Update to 3.10.1
